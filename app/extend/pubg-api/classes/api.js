...
class PubgApi {
  ...
  */
   ...
   *
   * @return {Promise<any>} Depending on the options.asyncType provided.
   */
  wrapAsync(promise) {
    return promise;
  }
  ...
  * @return {Promise<any>} A Promise with the result or an error
  */
  ...
  *
  * @return {Promise<Match>} A Promise with the result or an error
  */
